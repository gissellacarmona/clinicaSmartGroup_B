# Generated by Django 4.1.1 on 2022-10-05 13:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enfermero', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='clinicaBackend.enfermero')),
                ('medico', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='clinicaBackend.medico')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
